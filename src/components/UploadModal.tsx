  ...
  const handleSavePrediction = async () => {
    ...
    try {
      ...
      const testRecord = {
        ...
        model_versions: {
          [predictionResult.modelUsed]: predictionResult.modelUsed === 'spiral' ? 'MobileNetV2-86.67%' : 'VGG16',
        },
        confidence: predictionResult.confidence,
      };
            ...
            {success ? (
                ...
                <div className="p-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="pt-3 border-t border-blue-200">
                                <div className="flex items-center gap-2 text-xs text-gray-700 bg-white rounded-lg p-2">
                                    ...
                                    <p>
                                        <strong className="text-gray-900">Model:</strong> {predictionResult.modelUsed === 'spiral' ? 'MobileNetV2 (86.67%)' : 'VGG16'}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <p className="text-center text-gray-600 mb-4 text-xs">
                        Analysis performed using trained {predictionResult.modelUsed === 'spiral' ? 'MobileNetV2' : 'VGG16'} neural network model.
                    </p>
